...
<Faq
  faqs={[
    ...
    },
    {
      ...
      answer:
        "No, the marketing footer only appears on pages using Starlight's splash template. This is intentional—regular documentation pages keep their standard layout while landing pages get the full marketing treatment.",
    },
    {
